...
def lambda_handler(event, context):
    ...
    if aws_environment == "AWS_SAM_LOCAL":
        ...
        table = boto3.resource('dynamodb', endpoint_url="http://host.docker.internal:8000/", region_name=region, aws_access_key_id="abcd", aws_secret_access_key="abcd").Table(table_name)
